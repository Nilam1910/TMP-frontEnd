  ...
  render(){
    ...
    <div style={{ height: "100vh", width: "100vw"}}>
      ...
      <div className="buttons">
           ...
           <button  className="button register" onClick={this.showRegisterPopup}> Register </button>
          ...
          {this.setCurrentUser ? (
              <button className="loginButton" onClick={this.showLoginPopup}>Log in</button>
              ) : ( 
